...
namespace SignalRWebUI.Controllers
{
    public class NotificationController : Controller
    {
        ...
        public async Task<IActionResult> CreateNotification(CreateNotificationDto createNotificationDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7074/api/Notifications", content);
        ...
        public async Task<IActionResult> UpdateNotification(UpdateNotificationDto updateNotificationDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7074/api/Notifications/", content);
        ...
        public async Task<IActionResult> NotificationStatusChangeToTrue(int id)
        {
            ...
            await client.GetAsync($"https://localhost:7074/api/Notifications/NotificationStatusChangeToTrue/{id}");
        ...
        public async Task<IActionResult> NotificationStatusChangeToFalse(int id)
        {
            ...
            await client.GetAsync($"https://localhost:7074/api/Notifications/NotificationStatusChangeToFalse/{id}");
